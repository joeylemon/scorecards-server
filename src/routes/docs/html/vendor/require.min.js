...
RegExp ? b[g] = c : (b[g] || (b[g] = {}), Z(b[g], c, d, k))
        ...
        function c (a, n, b) {
            var f, l, c, d, h, k, e, A; n = n && n.split('/'); var q = m.map; var p = q && q['*']; if (a) {
...
V.test(a[l]) && (a[l] = a[l].replace(V, '')); a[0].charAt(0) === '.' && n && (l = n.slice(0, n.length - 1), a = l.concat(a)); l = a; for (c = 0; c < l.length; c++)d = l[c], d === '.' ? (l.splice(c, 1), --c) : d === '..' && c !== 0 && (c !== 1 || l[2] !== '..') && l[c - 1] !== '..' && c > 0 && (l.splice(c - 1, 2), c -= 2); a = a.join('/')
        ...
        } function d (a) { F && x(document.getElementsByTagName('script'), function (n) { if (n.getAttribute('data-requiremodule') === a && n.getAttribute('data-requirecontext') === h.contextName) return n.parentNode.removeChild(n), !0 }) } function p (a) { var n = g(m.paths, a); if (n && M(n) && n.length > 1) return n.shift(), h.require.undef(a), h.makeRequire(null, { skipMap: !0 })([a]), !0 } function e (a) { var n; var b = a ? a.indexOf('!') : -1; b > -1 && (n = a.substring(0, b), a = a.substring(b + 1, a.length)); return [n, a] } function q (a,
            n, b, f) { var l; var d; var z = null; var k = n ? n.name : null; var m = a; var q = !0; var A = ''; a || (q = !1, a = '_@r' + (R += 1)); a = e(a); z = a[0]; a = a[1]; z && (z = c(z, k, f), d = g(r, z)); a && (z ? A = d && d.normalize ? d.normalize(a, function (a) { return c(a, k, f) }) : a.indexOf('!') === -1 ? c(a, k, f) : a : (A = c(a, k, f), a = e(A), z = a[0], A = a[1], b = !0, l = h.nameToUrl(A))); b = !z || d || b ? '' : '_unnormalized' + (U += 1); return { prefix: z, name: A, parentMap: n, unnormalized: !!b, url: l, originalName: m, isDefine: q, id: (z ? z + '!' + A : A) + b } } function u (a) { var b = a.id; var c = g(t, b); c || (c = t[b] = new h.Module(a)); return c } function v (a,
            b, c) { var f = a.id; var l = g(t, f); if (!w(r, f) || l && !l.defineEmitComplete) if (l = u(a), l.error && b === 'error')c(l.error); else l.on(b, c); else b === 'defined' && c(r[f]) } function B (a, b) { var c = a.requireModules; var f = !1; if (b)b(a); else if (x(c, function (b) { if (b = g(t, b))b.error = a, b.events.error && (f = !0, b.emit('error', a)) }), !f)k.onError(a) } function C () { W.length && (x(W, function (a) { var b = a[0]; typeof b === 'string' && (h.defQueueMap[b] = !0); H.push(a) }), W = []) } function D (a) { delete t[a]; delete aa[a] } function K (a, b, c) {
            var f = a.map.id; a.error ? a.emit('error',
                a.error) : (b[f] = !0, x(a.depMaps, function (f, d) { var h = f.id; var k = g(t, h); !k || a.depMatched[d] || c[h] || (g(b, h) ? (a.defineDep(d, r[h]), a.check()) : K(k, b, c)) }), c[f] = !0)
        } function I () {
            var a; var b; var c = (a = 1E3 * m.waitSeconds) && h.startTime + a < (new Date()).getTime(); var f = []; var l = []; var k = !1; var g = !0; if (!ba) {
                ba = !0; E(aa, function (a) { var h = a.map; var e = h.id; if (a.enabled && (h.isDefine || l.push(a), !a.error)) if (!a.inited && c)p(e) ? k = b = !0 : (f.push(e), d(e)); else if (!a.inited && a.fetched && h.isDefine && (k = !0, !h.prefix)) return g = !1 }); if (c && f.length) {
                    return a = G('timeout',
        ...
        function Q () { var a; for (C(); H.length;) { a = H.shift(); if (a[0] === null) return B(G('mismatch', 'Mismatched anonymous define() module: ' + a[a.length - 1])); J(a) }h.defQueueMap = {} } var ba; var ea; var h; var S; var ca; var m = { waitSeconds: 7, baseUrl: './', paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {} }; var t = {}; var aa = {}; var fa = {}; var H = []; var r = {}; var X = {}; var ga = {}; var R = 1; var U = 1; S = {
...
{}
            ...
            load: function () { var a = this.map.url; X[a] || (X[a] = !0, h.load(this.map.id, a)) },
            check: function () {
                if (this.enabled && !this.enabling) {
                    var a; var b; var c = this.map.id; b = this.depExports; var f = this.exports; var l = this.factory; if (!this.inited)w(h.defQueueMap, c) || this.fetch(); else if (this.error) this.emit('error', this.error); else if (!this.defining) {
            ...
            callPlugin: function () {
                var a = this.map; var b = a.id; var d = q(a.prefix); this.depMaps.push(d); v(d, 'defined', y(this, function (f) {
                    var l; var d; var e = g(ga, this.map.id); var N = this.map.name; var p = this.map.parentMap ? this.map.parentMap.name : null; var r = h.makeRequire(a.parentMap, { enableBuildCallback: !0 }); if (this.map.unnormalized) {
                        ...
                        }), l.fromText = y(this, function (f, c) { var d = a.name; var e = q(d); var N = T; c && (f = c); N && (T = !1); u(e); w(m.config, b) && (m.config[d] = m.config[b]); try { k.exec(f) } catch (g) { return B(G('fromtexteval', 'fromText eval for ' + b + ' failed: ' + g, g, [b])) }N && (T = !0); this.depMaps.push(e); h.completeLoad(d); r([d], l) }), f.load(a.name, r, l, m))
                    }
...
g(t, a.id); b && !b.enabled && h.enable(a, this)
            ...
            configure: function (a) {
                a.baseUrl && a.baseUrl.charAt(a.baseUrl.length - 1) !== '/' && (a.baseUrl += '/'); var b = m.shim; var c = {
                    paths: !0,
                    bundles: !0,
                    config: !0,
                    map: !0
            ...
            makeShimExports: function (a) { return function () { var b; a.init && (b = a.init.apply(ha, arguments)); return b || a.exports && ja(a.exports) } },
            makeRequire: function (a, n) {
                function e (c, d, g) {
                    ...
                    isBrowser: F,
                    toUrl: function (b) { var d; var e = b.lastIndexOf('.'); var n = b.split('/')[0]; e !== -1 && (n !== '.' && n !== '..' || e > 1) && (d = b.substring(e, b.length), b = b.substring(0, e)); return h.nameToUrl(c(b, a && a.id, !0), d, !0) },
                    defined: function (b) {
                        return w(r,
                            q(b, a, !1, !0).id)
                    },
                    specified: function (b) { b = q(b, a, !1, !0).id; return w(r, b) || w(t, b) }
                }); a || (e.undef = function (b) { C(); var c = q(b, a, !0); var e = g(t, b); e.undefed = !0; d(b); delete r[b]; delete X[c.url]; delete fa[b]; Y(H, function (a, c) { a[0] === b && H.splice(c, 1) }); delete h.defQueueMap[b]; e && (e.events.defined && (fa[b] = e.events), D(b)) }); return e
            },
            enable: function (a) { g(t, a.id) && u(a).enable() },
            completeLoad: function (a) {
                var b; var c; var d = g(m.shim, a) || {}; var e = d.exports; for (C(); H.length;) {
...
c ? '' : '.js'); d = (d.charAt(0) === '/' || d.match(/^[\w\+\.\-]+:/) ? '' : m.baseUrl) + d
            ...
            load: function (a, b) { k.load(h, a, b) },
            execCb: function (a, b, c, d) { return b.apply(d, c) },
            onScriptLoad: function (a) { if (a.type === 'load' || oa.test((a.currentTarget || a.srcElement).readyState))O = null, a = P(a), h.completeLoad(a.id) },
    ...
    } function pa () { if (O && O.readyState === 'interactive') return O; Y(document.getElementsByTagName('script'), function (b) { if (b.readyState === 'interactive') return O = b }); return O } var k; var C; var D; var I; var P; var J; var O; var Q; var u; var U; var qa = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/mg; var ra = /[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g; var V = /\.js$/; var na = /^\.\//; C = Object.prototype; var R = C.toString; var la = C.hasOwnProperty
    var F = !(typeof window === 'undefined' || typeof navigator === 'undefined' || !window.document); var ka = !F && typeof importScripts !== 'undefined'; var oa = F && navigator.platform === 'PLAYSTATION 3' ? /^complete$/ : /^(complete|loaded)$/; var da = typeof opera !== 'undefined' && opera.toString() === '[object Opera]'; var K = {}; var v = {}; var W = []; var T = !1; if (typeof define === 'undefined') {
