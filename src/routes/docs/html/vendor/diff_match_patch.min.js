(function () {
    ...
    diff_match_patch.prototype.diff_main = function (a, b, c, d) {
        typeof d === 'undefined' && (d = this.Diff_Timeout <= 0 ? Number.MAX_VALUE : (new Date()).getTime() + 1E3 * this.Diff_Timeout); if (a == null || b == null) throw Error('Null input. (diff_main)'); if (a == b) return a ? [[0, a]] : []; typeof c === 'undefined' && (c = !0); var e = c; var f = this.diff_commonPrefix(a, b); c = a.substring(0, f); a = a.substring(f); b = b.substring(f); var f = this.diff_commonSuffix(a, b); var g = a.substring(a.length - f); a = a.substring(0, a.length - f); b = b.substring(0, b.length - f); a = this.diff_compute_(a,
            b, e, d); c && a.unshift([0, c]); g && a.push([0, g]); this.diff_cleanupMerge(a); return a
    }
    diff_match_patch.prototype.diff_compute_ = function (a, b, c, d) {
        if (!a) return [[1, b]]; if (!b) return [[-1, a]]; var e = a.length > b.length ? a : b; var f = a.length > b.length ? b : a; var g = e.indexOf(f); return g != -1 ? (c = [[1, e.substring(0, g)], [0, f], [1, e.substring(g + f.length)]], a.length > b.length && (c[0][0] = c[2][0] = -1), c) : f.length == 1 ? [[-1, a], [1, b]] : (e = this.diff_halfMatch_(a, b)) ? (f = e[0], a = e[1], g = e[2], b = e[3], e = e[4], f = this.diff_main(f, g, c, d), c = this.diff_main(a, b, c, d), f.concat([[0, e]], c)) : c && a.length > 100 && b.length > 100 ? this.diff_lineMode_(a, b,
...
u) return this.diff_bisectSplit_(a, b, m, s, c)
    ...
    diff_match_patch.prototype.diff_bisectSplit_ = function (a, b, c, d, e) { var f = a.substring(0, c); var g = b.substring(0, d); a = a.substring(c); b = b.substring(d); f = this.diff_main(f, g, !1, e); e = this.diff_main(a, b, !1, e); return f.concat(e) }
    diff_match_patch.prototype.diff_linesToChars_ = function (a, b) { function c (a) { for (var b = '', c = 0, f = -1, g = d.length; f < a.length - 1;) { f = a.indexOf('\n', c); f == -1 && (f = a.length - 1); var r = a.substring(c, f + 1); var c = f + 1; (e.hasOwnProperty ? e.hasOwnProperty(r) : void 0 !== e[r]) ? b += String.fromCharCode(e[r]) : (b += String.fromCharCode(g), e[r] = g, d[g++] = r) } return b } var d = []; var e = {}; d[0] = ''; var f = c(a); var g = c(b); return { chars1: f, chars2: g, lineArray: d } }
    ...
    diff_match_patch.prototype.diff_halfMatch_ = function (a, b) {
        function c (a, b, c) { for (var d = a.substring(c, c + Math.floor(a.length / 4)), e = -1, g = '', h, j, n, l; (e = b.indexOf(d, e + 1)) != -1;) { var m = f.diff_commonPrefix(a.substring(c), b.substring(e)); var s = f.diff_commonSuffix(a.substring(0, c), b.substring(0, e)); g.length < s + m && (g = b.substring(e - s, e) + b.substring(e, e + m), h = a.substring(0, c - s), j = a.substring(c + m), n = b.substring(0, e - s), l = b.substring(e + m)) } return 2 * g.length >= a.length ? [h, j, n, l, g] : null } if (this.Diff_Timeout <= 0) return null
        var d = a.length > b.length ? a : b; var e = a.length > b.length ? b : a; if (d.length < 4 || 2 * e.length < d.length) return null; var f = this; var g = c(d, e, Math.ceil(d.length / 4)); var d = c(d, e, Math.ceil(d.length / 2)); var h; if (!g && !d) return null; h = d ? g ? g[4].length > d[4].length ? g : d : d : g; var j; a.length > b.length ? (g = h[0], d = h[1], e = h[2], j = h[3]) : (e = h[0], j = h[1], g = h[2], d = h[3]); h = h[4]; return [g, d, e, j, h]
    }
    ...
    diff_match_patch.prototype.diff_cleanupSemanticLossless = function (a) {
        function b (a, b) {
            if (!a || !b) return 6; var c = a.charAt(a.length - 1); var d = b.charAt(0); var e = c.match(diff_match_patch.nonAlphaNumericRegex_); var f = d.match(diff_match_patch.nonAlphaNumericRegex_); var g = e && c.match(diff_match_patch.whitespaceRegex_); var h = f && d.match(diff_match_patch.whitespaceRegex_); var c = g && c.match(diff_match_patch.linebreakRegex_); var d = h && d.match(diff_match_patch.linebreakRegex_); var i = c && a.match(diff_match_patch.blanklineEndRegex_); var j = d && b.match(diff_match_patch.blanklineStartRegex_)
            return i || j ? 5 : c || d ? 4 : e && !g && h ? 3 : g || h ? 2 : e || f ? 1 : 0
        } for (var c = 1; c < a.length - 1;) {
            if (a[c - 1][0] == 0 && a[c + 1][0] == 0) {
                var d = a[c - 1][1]; var e = a[c][1]; var f = a[c + 1][1]; var g = this.diff_commonSuffix(d, e); if (g) var h = e.substring(e.length - g); var d = d.substring(0, d.length - g); var e = h + e.substring(0, e.length - g); var f = h + f; for (var g = d, h = e, j = f, i = b(d, e) + b(e, f); e.charAt(0) === f.charAt(0);) { var d = d + e.charAt(0); var e = e.substring(1) + f.charAt(0); var f = f.substring(1); var k = b(d, e) + b(e, f); k >= i && (i = k, g = d, h = e, j = f) }a[c - 1][1] != g && (g ? a[c - 1][1] = g : (a.splice(c - 1, 1), c--), a[c][1] =
...
g), e = e.substring(0, e.length - g))), c === 0 ? a.splice(b - d, c + d, [1, f]) : d === 0 ? a.splice(b - c, c + d, [-1, e]) : a.splice(b - c - d, c + d, [-1, e], [1, f]), b = b - c - d + (c ? 1 : 0) + (d ? 1 : 0) + 1) : b !== 0 && a[b - 1][0] == 0 ? (a[b - 1][1] += a[b][1], a.splice(b, 1)) : b++, c = d = 0, f = e = ''
    ...
    }; diff_match_patch.prototype.diff_xIndex = function (a, b) { var c = 0; var d = 0; var e = 0; var f = 0; var g; for (g = 0; g < a.length; g++) { a[g][0] !== 1 && (c += a[g][1].length); a[g][0] !== -1 && (d += a[g][1].length); if (c > b) break; e = c; f = d } return a.length != g && a[g][0] === -1 ? f : f + (b - e) }
    diff_match_patch.prototype.diff_prettyHtml = function (a) { for (var b = [], c = /&/g, d = /</g, e = />/g, f = /\n/g, g = 0; g < a.length; g++) { var h = a[g][0]; var j = a[g][1]; var j = j.replace(c, '&amp;').replace(d, '&lt;').replace(e, '&gt;').replace(f, '&para;<br>'); switch (h) { case 1:b[g] = '<ins style="background:#e6ffe6;">' + j + '</ins>'; break; case -1:b[g] = '<del style="background:#ffe6e6;">' + j + '</del>'; break; case 0:b[g] = '<span>' + j + '</span>' } } return b.join('') }
    diff_match_patch.prototype.diff_text1 = function (a) { for (var b = [], c = 0; c < a.length; c++)a[c][0] !== 1 && (b[c] = a[c][1]); return b.join('') }; diff_match_patch.prototype.diff_text2 = function (a) { for (var b = [], c = 0; c < a.length; c++)a[c][0] !== -1 && (b[c] = a[c][1]); return b.join('') }; diff_match_patch.prototype.diff_levenshtein = function (a) { for (var b = 0, c = 0, d = 0, e = 0; e < a.length; e++) { var f = a[e][0]; var g = a[e][1]; switch (f) { case 1:c += g.length; break; case -1:d += g.length; break; case 0:b += Math.max(c, d), d = c = 0 } } return b += Math.max(c, d) }
...
f[g])
    ...
    diff_match_patch.prototype.match_bitap_ = function (a, b, c) {
        function d (a, d) { var e = a / b.length; var g = Math.abs(c - d); return !f.Match_Distance ? g ? 1 : e : e + g / f.Match_Distance } if (b.length > this.Match_MaxBits) throw Error('Pattern too long for this browser.'); var e = this.match_alphabet_(b); var f = this; var g = this.Match_Threshold; var h = a.indexOf(b, c); h != -1 && (g = Math.min(d(0, h), g), h = a.lastIndexOf(b, c + b.length), h != -1 && (g = Math.min(d(0, h), g))); for (var j = 1 << b.length - 1, h = -1, i, k, q = b.length + a.length, r, t = 0; t < b.length; t++) {
            i = 0; for (k = q; i < k;) {
                d(t, c +
...
c.length + d.length; a.length2 += c.length + d.length
    ...
    diff_match_patch.prototype.patch_make = function (a, b, c) {
        ...
        if (b.length === 0) return []; c = []; a = new diff_match_patch.patch_obj(); for (var e = 0, f = 0, g = 0, h = d, j = 0; j < b.length; j++) {
            var i = b[j][0]; var k = b[j][1]; !e && i !== 0 && (a.start1 = f, a.start2 = g); switch (i) {
...
e && (this.patch_addContext_(a, h), c.push(a), a = new diff_match_patch.patch_obj(), e = 0, h = d, f = g)
    ...
    }; diff_match_patch.prototype.patch_deepCopy = function (a) { for (var b = [], c = 0; c < a.length; c++) { var d = a[c]; var e = new diff_match_patch.patch_obj(); e.diffs = []; for (var f = 0; f < d.diffs.length; f++)e.diffs[f] = d.diffs[f].slice(); e.start1 = d.start1; e.start2 = d.start2; e.length1 = d.length1; e.length2 = d.length2; b[c] = e } return b }
    diff_match_patch.prototype.patch_apply = function (a, b) {
        if (a.length == 0) return [b, []]; a = this.patch_deepCopy(a); var c = this.patch_addPadding(a); b = c + b + c; this.patch_splitMax(a); for (var d = 0, e = [], f = 0; f < a.length; f++) {
            var g = a[f].start2 + d; var h = this.diff_text1(a[f].diffs); var j; var i = -1; if (h.length > this.Match_MaxBits) { if (j = this.match_main(b, h.substring(0, this.Match_MaxBits), g), j != -1 && (i = this.match_main(b, h.substring(h.length - this.Match_MaxBits), g + h.length - this.Match_MaxBits), i == -1 || j >= i))j = -1 } else j = this.match_main(b, h, g)
        ...
        for (var b = this.Match_MaxBits, c = 0; c < a.length; c++) {
            if (!(a[c].length1 <= b)) {
                var d = a[c]; a.splice(c--, 1); for (var e = d.start1, f = d.start2, g = ''; d.diffs.length !== 0;) {
                    var h = new diff_match_patch.patch_obj(); var j = !0; h.start1 = e - g.length; h.start2 = f - g.length; g !== '' && (h.length1 = h.length2 = g.length, h.diffs.push([0, g])); for (;d.diffs.length !== 0 && h.length1 < b - this.Patch_Margin;) {
